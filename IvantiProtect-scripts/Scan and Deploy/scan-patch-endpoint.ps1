# Patch Scan and Deploy (endpoint)
...
if (Get-Module -ListAvailable -Name STProtect) {
    ...
    $patchscan = Start-PatchScan -CredentialFriendlyName $credentialFriendlyName -EndpointNames $Endpointname -TemplateName $ScanTemplateName | Wait-PatchScan
