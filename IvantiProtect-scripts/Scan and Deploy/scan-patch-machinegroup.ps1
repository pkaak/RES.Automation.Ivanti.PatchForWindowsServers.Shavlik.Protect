# Patch Scan and Deploy (machine group)
# for Ivanti Patch for Windows (Servers)
# version 2.0
#
# Start and scan an endpoint
# v2.0: Added option to use a scan- end deploymenttemplate
#
# patrick.kaak@ivanti.com
# @pkaak

# Set variables
$MGroupName = "Automation Test"
...
if (Get-Module -ListAvailable -Name STProtect) {
    ...
    $patchscan = Start-PatchScan -CredentialFriendlyName $credentialFriendlyName -MachineGroups $MGroupName -TemplateName $ScanTemplateName | Wait-PatchScan
    $patchdeploy = Start-PatchDeploy –ScanUid ($patchscan.Uid) -TemplateName $DeploymentTemplate
    ...
    # Seperate columns by ;
    # Seperate rows by |
    # deployment-guid;endpoint;domain;IP Address;Completed Patches;Overall State;Last Updated;errorcode;statusdescription
