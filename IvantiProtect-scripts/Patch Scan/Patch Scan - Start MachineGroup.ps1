# Patch Scan Machinegroup - Start scan
...
if (Get-Module -ListAvailable -Name STProtect) {
    ...
    $patchscan = Start-PatchScan -CredentialFriendlyName $credentialFriendlyName -MachineGroups $MGroupName -TemplateName $TemplateName
